...
<head>
    ...
    <title>Edit Campaign - {{ $campaign->subject }}</title>
    <style>
        body {
    ...
    <div class="container">
        ...
        <form action="{{ route('campaigns.update', $campaign->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea name="email_body" id="email_body" required>{{ old('email_body', $campaign->email_body) }}</textarea>
                @error('email_body')
                    <div class="error">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="phishing_link" id="phishing_link" value="{{ old('phishing_link', $campaign->phishing_link) }}" required>
                @error('phishing_link')
                    <div class="error">{{ $message }}</div>
                @enderror
            </div>
